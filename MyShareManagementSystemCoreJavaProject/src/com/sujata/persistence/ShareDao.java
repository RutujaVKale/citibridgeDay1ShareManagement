...
public interface ShareDao {
	...
	boolean deleteShareResordById(int shareId) throws ClassNotFoundException ,SQLException;
	boolean updateShareById(int shareId, int marketRate) throws ClassNotFoundException, SQLException;
